        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    if (item === "trigger-delete-modal") {
                        Livewire.emit("trashDelete", { model, id });
                    } else if (item === "trigger-restore-modal") {
                        Livewire.emit("restoreTrash", { model, id });
                    } else if (item === "trigger-force-delete-modal") {
                        Livewire.emit("forceDelete", { model, id });
                    }
                }
            })
            .catch(console.log);
